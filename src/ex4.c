...
/*   Updated: 2021/01/29 21:30:12 by juhani           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				main(int argc, char **argv)
{
	...
	mlx_win->element1 = create_element(mlx_win, &elem1_start_position, degree);
	mlx_win->element2 = create_element(mlx_win, &elem2_start_position, degree);
	ft_memdel((void **)&degree);
